  ...
  group('LoginService 智能API选择测试', () {
    ...
    test('保存用户详情格式验证', () async {
      ...
      final mockUserDetail = {
        ...
        'profile': {
          'userId': 375334328,
          'nickname': 'YiktLLW',
          'avatarUrl': 'http://p1.music.126.net/cJMGNeFS-okVM9VJ96HaFA==/109951168824917156.jpg',
          'signature': 'brahms..',
          'userType': 0,
          'vipType': 11,
          'gender': 1,
          ...
          'authStatus': 0,
          'authority': 0,
          'backgroundUrl': 'http://p1.music.126.net/JVbDAh4nWTHAdQOoiFMBrA==/109951166370794851.jpg',
          'defaultAvatar': false,
        }
      };
      ...
      expect(mockUserDetail['listenSongs'], isNotNull, reason: 'listenSongs字段应该存在');
      ...
      expect(profile['playlistCount'], isNotNull, reason: 'playlistCount字段应该存在');
    ...
    test('用户信息字段映射验证', () async {
      ...
      final userDetailFields = [
        'userId', 'nickname', 'avatarUrl', 'signature', 'userType', 'vipType',
        'gender', 'birthday', 'province', 'city', 'followed', 'followeds', 
        'follows', 'level', 'listenSongs', 'createTime', 'description',
        'detailDescription', 'eventCount', 'playlistCount', 'playlistBeSubscribedCount',
        'djStatus', 'mutual', 'accountStatus', 'authStatus', 'authority',
        'backgroundUrl', 'defaultAvatar'
      ];
      ...
      expect(userDetailFields.contains('listenSongs'), isTrue, reason: '应该包含listenSongs字段');
      expect(userDetailFields.contains('playlistCount'), isTrue, reason: '应该包含playlistCount字段');
